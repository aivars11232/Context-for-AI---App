...
- State the file and reason before editing.
- Run the required verification after each meaningful change.
...
5. Whether TASK-0001 exit criteria are fully satisfied.
